...
for line in lines:
    ...
    if 'print(f"  Cond. Financieras: {financial_regime} (conf: {liq_conf:.0%})")' in line:
        new_lines.append('    print("Calculando liquidez real (FRED)...")\n')
        new_lines.append('    from regimes.liquidity import compute_liquidity_score as compute_real_liquidity\n')
...
print('Bloque de liquidez real insertado en run.py.')
