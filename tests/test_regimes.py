...
import sys
sys.path.insert(0, '.')
from regimes.liquidity_regime import compute_liquidity_score
...
def test_liquidity_returns_valid_types():
    # Simplemente verifica que la función devuelve tipos correctos con datos minimos
    n = 200
    # Ruido aleatorio para evitar MAD=0
    np.random.seed(123)
