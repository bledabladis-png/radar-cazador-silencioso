...
Versiones anteriores: 1.1 (commit 52fc53c; preservada como
...
Estado: ESPECIFICACION. C1 + C4 aplicadas (dictamen v1.1, 2026-09-19).
        Pendiente: NIPC_COVERAGE_POLICY.md (thresholds).
        Gate-NIPC.2 autorizado tras cerrar ambos.
Naturaleza: no normativo. Si hay conflicto con el Prompt Maestro, gana
            el Prompt Maestro.
Referencia: prompt v6.35, HEAD local bae4794.
...
Fin de la especificacion v1.2. Fecha: 2026-09-19. HEAD local al redactar:
bae4794. Estado: C1 + C4 aplicadas. Pendiente: NIPC_COVERAGE_POLICY.md
(thresholds) antes de autorizar Gate-NIPC.2 (implementacion). Las
versiones v1.0 y v1.1 se preservan como INSTITUTIONAL_ACCUMULATION_NIPC_
ESPECIFICACION_v1.0.md y _v1.1.md respectivamente.
