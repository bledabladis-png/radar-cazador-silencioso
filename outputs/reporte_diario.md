...
|---|--------|-------|---------------|
| 1 | Financials (XLF) | 0.38 | RANGE |
| 2 | Utilities (XLU) | 0.27 | RANGE |
| 3 | Real Estate (XLRE) | 0.20 | RANGE |
| 4 | Industrials (XLI) | 0.18 | RANGE |
| 5 | Consumer Staples (XLP) | 0.11 | RANGE |
| 6 | Healthcare (XLV) | 0.11 | RANGE |
...
| # | Sector | Retorno 20d (%) |
|---|--------|------------------|
| 1 | Healthcare (XLV) | 7.74% |
| 2 | Financials (XLF) | 7.40% |
| 3 | Industrials (XLI) | 6.18% |
| 4 | Utilities (XLU) | 5.82% |
| 5 | Materials (XLB) | 4.49% |
| 6 | Consumer Staples (XLP) | 3.02% |
| 7 | Real Estate (XLRE) | 2.37% |
| 8 | Consumer Discretionary (XLY) | 1.70% |
| 9 | Communication Services (XLC) | -1.08% |
| 10 | Technology (XLK) | -1.83% |
| 11 | Energy (XLE) | -8.10% |

## Flujo Institucional - Sectores (Proxy)
| # | Sector | Flujo (z-score) |
|---|--------|------------------|
| 1 | Healthcare (XLV) | 1.13 |
| 2 | Utilities (XLU) | 0.33 |
| 3 | Consumer Staples (XLP) | 0.25 |
| 4 | Communication Services (XLC) | 0.24 |
| 5 | Financials (XLF) | 0.22 |
